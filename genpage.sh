...
vars=$(cat << EOF
COLLECTDPW_VERSION=5.2.1.20130326
COLLECTDPW_PACKAGE=collectd-5.2.1.20130326.tar.gz
PERFWATCHER_VERSION=1.1
PERFWATCHER_PACKAGE=perfwatcher-1.1.20130325.tar.gz
EOF
)
