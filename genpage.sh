...
vars=$(cat << EOF
COLLECTDPW_VERSION=5.3.0.20130426
COLLECTDPW_PACKAGE=collectd-5.3.0.20130426.tar.gz
PERFWATCHER_VERSION=1.2
PERFWATCHER_PACKAGE=perfwatcher-1.2.20130429.tar.gz
EOF
)
