...
vars=$(cat << EOF
COLLECTDPW_VERSION=5.3.0.20130829
COLLECTDPW_PACKAGE=collectd-5.3.0.20130829.tar.gz
PERFWATCHER_VERSION=1.3
PERFWATCHER_PACKAGE=perfwatcher-1.3.20130829.tar.gz
EOF
)
